...
import static de.mikeyllp.miniGamesV4.map.InvitetPlayerHashMap.removeInvite;
//adds all online players to the tab completer
public class DeclinedMiniGamesCommand extends CommandAPICommand {
    public DeclinedMiniGamesCommand(String commandName) {
        super(commandName);
